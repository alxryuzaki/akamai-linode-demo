...
public class Controller{
    ...
    public String save(Model model,
                     ...
                     @RequestParam(value = "name") @NotNull @NotBlank(message = "Name is mandatory") String name,
                     @RequestParam(value = "phone") @NotNull @NotBlank(message = "Phone is mandatory") String phone) throws PhonebookAlreadyExistsException, PhonebookNotFoundException{
    ...
    public String delete(Model model,
                         HttpServletRequest request,
                       @RequestParam(value = "q", required = false) String q,
                       @RequestParam(value = "id") Integer id) throws PhonebookNotFoundException{
