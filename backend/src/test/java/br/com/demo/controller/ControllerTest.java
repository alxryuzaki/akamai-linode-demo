...
class ControllerTest{
    ...
    void saveExistingItem() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/save").param("id", mockItem.getId().toString()).param("name", mockItem.getName()).param("phone", mockItem.getPhone())).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.model().attribute("result", mockList));
    ...
    void saveNewItem() throws Exception{
        Mockito.when(mockService.findByNameContaining("")).thenReturn(mockList);
        Mockito.when(mockService.findByName(mockItem.getName())).thenReturn(EMPTY_LIST);
    
        mockMvc.perform(MockMvcRequestBuilders.post("/save").param("name", mockItem.getName()).param("phone", mockItem.getPhone())).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.model().attribute("result", mockList));
